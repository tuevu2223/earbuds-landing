...
function FeatureCard({ feature }) {
  ...
  return (
    <div className={`grid grid-cols-1 lg:grid-cols-2 gap-10 items-center ${imageLeft ? "lg:grid-flow-dense" : ""}`}>
      <div className={`flex items-center justify-center ${imageLeft ? "lg:col-start-2" : ""}`}>
        <div className="relative bg-theme-box rounded-3xl overflow-hidden shadow-lg border border-theme-accent/10 w-full max-w-sm aspect-square">
          <Image
            src={image}
            alt={imageAlt}
            fill
      ...
      <div className={`flex flex-col gap-6 ${imageLeft ? "lg:col-start-1 lg:row-start-1" : ""}`}>
        ...
        <div className="grid grid-cols-3 gap-4">
          {stats.map((stat, i) => (
            <div
              key={i}
              className="bg-theme-box rounded-2xl p-4 text-center shadow-md border border-theme-accent/10"
            >
